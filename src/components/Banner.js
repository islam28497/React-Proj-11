          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Islam Mohamed Abdelaziz,`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "FullStack Web Developer", "FrontEnd Developer", "BackEnd Developer" ]'><span className="wrap">{text}</span></span></h1>
